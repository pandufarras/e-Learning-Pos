                            ...
                            <div class="card-body">
                                <div class="uk-flex-middle" uk-grid>
                                    ...
                                    <div class="uk-width-expand">
                                        <img src="{{ asset('admins/images/demos/d-sales.png')}}" alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="uk-flex-middle" uk-grid>
                                    ...
                                    <div class="uk-width-expand">
                                        <img src="{{ asset('admins/images/demos/d-student.png')}}" alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="uk-flex-middle" uk-grid>
                                    ...
                                    <div class="uk-width-expand">
                                        <img src="{{ asset('admins/images/demos/d-graduation.png')}}" alt="">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="uk-height-large" data-simplebar>
                ...
                <div class="uk-grid-small p-4" uk-grid>
                    <div class="uk-width-1-3@m">
                        <img src="{{ asset('admins/images/course/2.png')}}" class="  rounded" alt="">
                    </div>
                    <div class="uk-width-expand">
                ...
                <div class="uk-grid-small p-4" uk-grid>
                    <div class="uk-width-1-3@m">
                        <img src="{{ asset('admins/images/course/3.png')}}" class="  rounded" alt="">
                    </div>
                    <div class="uk-width-expand">
                ...
                <div class="uk-grid-small p-4" uk-grid>
                    <div class="uk-width-1-3@m">
                        <img src="{{ asset('admins/images/course/1.png')}}" class="  rounded" alt="">
                    </div>
                    <div class="uk-width-expand">
                ...
                <ul class="uk-slider-items uk-child-width-1-3@m uk-child-width-1-2@s pb-3 uk-grid">
                    ...
                    <li>
                            <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        <div class="avatar-parent-child">
                                            <img alt="Image placeholder" src="{{ asset('admins/images/avatars/avatar-2.jpg')}}"
                            ...
                            <li>
                                    ...
                                    <div class="card-body text-center">
                                        <div class="avatar-parent-child">
                                            <img alt="Image placeholder" src="{{ asset('admins/images/avatars/avatar-1.jpg')}}"
                                                class="avatar  rounded-circle avatar-lg">
                                            <span class="avatar-child avatar-badge bg-success"></span>
                                        </div>
                            ...
                            <li>
                                    ...
                                    <div class="card-body text-center">
                                        <div class="avatar-parent-child">
                                            <img alt="Image placeholder" src="{{ asset('admins/images/avatars/avatar-3.jpg')}}"
                                                class="avatar  rounded-circle avatar-lg">
                                            <span class="avatar-child avatar-badge bg-success"></span>
                                        </div>
                            ...
                            <li>
                                    ...
                                    <div class="card-body text-center">
                                        <div class="avatar-parent-child">
                                            <img alt="Image placeholder" src="{{ asset('admins/images/avatars/avatar-4.jpg')}}"
                                                class="avatar  rounded-circle avatar-lg">
                                            <span class="avatar-child avatar-badge bg-success"></span>
                                        </div>
                                        <h5 class="h6 mt-4 mb-0"> Stella Johnson</h5>
